...
public class IncomingData {
  ...
  public static String NeRabStu="select distinct  agent_id, DAY (SYSDATETIME())-DAY (max(mtime)) as NERAB from vel.f_ticket where agent_id NOT in(" + ImportExStu.exStuStr() + ") GROUP BY agent_id  having (DAY (SYSDATETIME())-DAY (max(mtime)))!=0  order by agent_id";
